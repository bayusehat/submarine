        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="collapse dont-collapse-sm contacts" id="collapse_3">
                    <ul>
                        <li><i class="ti-home"></i>Jemur Wonosari GG. Sekolahan 19<br>Surabaya - ID</li>
                        <li><i class="ti-headphone-alt"></i>+62-89-5364-791-632</li>
                        <li><i class="ti-email"></i><a href="#0">submarine.recs@gmail.com</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <div class="collapse dont-collapse-sm" id="collapse_4">
                    ...
                    <div class="follow_us">
                        ...
                        <ul>
                            ...
                            <li><a href="https://instagram.com/submarine.recs"><img src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" data-src="{{ asset('assets/img/instagram_icon.svg') }}" alt="" class="lazy"></a></li>
        ...
        <div class="row add_bottom_25">
            ...
            <div class="col-lg-6">
                <ul class="additional_links">
                    ...
                    <li><span>© 2023 Submarine Records</span></li>
                </ul>
            </div>
        </div>
    </div>
