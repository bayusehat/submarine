                        ...
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-lg-6 static">
                                <div class="slide-text white">
                                    <h2 class="owl-slide-animated owl-slide-title">New Release<br> Single debut from GRUFF</h2>
                                    <p class="owl-slide-animated owl-slide-subtitle">
                                        Available on our Bandcamp Page
                                    </p>
                                    <div class="owl-slide-animated owl-slide-cta"><a class="btn_1" target="_blank" href="https://submarine-records.bandcamp.com/track/fault" role="button">Stream Now</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center justify-content-md-start">
                            <div class="col-lg-12 static">
                                <div class="slide-text text-center black">
                                    <h2 class="owl-slide-animated owl-slide-title">Follow Us<br> on Instagram</h2>
                                    <p class="owl-slide-animated owl-slide-subtitle">
                                        For any release update & event
                                    </p>
                                    <div class="owl-slide-animated owl-slide-cta"><a class="btn_1" href="https://instagram.com/submarine.recs" role="button">Visit Now</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
