...
<head>
    ...
    <meta name="description" content="Submarine Records Official Website">
    <meta name="author" content="Submarine Records">
    <title>Submarine Records Official Site</title>
			...
			<div class="container">
				<div class="row small-gutters">
					<div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
						<div id="logo">
							<a href="{{ url('/') }}"><img src="{{ asset('assets/img/logo-submarine.png') }}" alt="" width="100" height="35"></a>
						</div>
					</div>
									...
									<div class="menu-wrapper">
										<div class="row small-gutters">
											<div class="col-lg-3">
												<h3>Releases</h3>
												<ul>
													<li><a href="listing-grid-1-full.html">CD</a></li>
													<li><a href="listing-grid-2-full.html"> Casette</a></li>
													<li><a href="listing-grid-3.html">Vinyl</a></li>
											...
											<div class="col-lg-3">
												<h3>Apparel</h3>
												<ul>
													<li><a href="listing-row-1-sidebar-left.html">T-shirt</a></li>
													<li><a href="listing-row-2-sidebar-right.html">Jackets</a></li>
													<li><a href="listing-row-3-sidebar-left.html">Accesoris</a></li>
											...
											<div class="col-lg-3">
												<h3>Other pages</h3>
												<ul>
													<li><a href="cart.html">Artists</a></li>
											...
											<div class="col-lg-3 d-xl-block d-lg-block d-md-none d-sm-none d-none">
												<div class="banner_menu">
													<a href="#0">
														<img src="{{ asset('assets/img/logo-submarine.png') }}" data-src="{{ asset('assets/img/logo-submarine.png') }}" width="400" height="550" alt="" class="img-fluid lazy">
													</a>
												</div>
											</div>
										</div>
					...
					<div class="col-xl-3 col-lg-2 d-lg-flex align-items-center justify-content-end text-end">
						<a class="phone_top" href="tel://9438843343"><strong><span>Need Help?</span>+62 89-5364-791-632</strong></a>
					</div>
				</div>
				<!-- /row -->
			</div>
